...
// СЕКТОР 330-360°: КРАСНЫЕ И ПУРПУРНЫЕ
colors.push(
  ...
  { id:"br6", color:"#ff1493", text:"Ярко‑розовый", tone:"тёплый", style:"романтический", season:"лето", colortype:"лето", textureHint:"Шифон", makeupHint:"Помада розовая", makeupSet:{ lips:"Ярко‑розовая", eyes:"Серебристые", blush:"Розовые", eyeliner:"Чёрная", style:"романтический" }, hue: 330 },
...
// СЕКТОР 30-60°: ОРАНЖЕВЫЕ И КОРИЧНЕВЫЕ
colors.push(
  { id:"brown11", color:"#E97451", text:"Рыже-красный", tone:"тёплый", style:"креативный", season:"осень", colortype:"осень", textureHint:"Кожа, замша", makeupHint:"Тени рыжие", makeupSet:{ lips:"Рыжая", eyes:"Рыжие", blush:"Тёплые", eyeliner:"Коричневая", style:"Креативный" }, hue: 15 },
  ...
  // ДОБАВЛЕННЫЕ ОРАНЖЕВЫЕ
  { id:"orange_miss1", color:"#FF7F50", text:"Коралловый", tone:"тёплый", style:"яркий", season:"осень", colortype:"осень", textureHint:"Шёлк", makeupHint:"Помада коралловая", makeupSet:{ lips:"Коралловая", eyes:"Золотистые", blush:"Тёплые", eyeliner:"Коричневая", style:"Яркий" }, hue: 55 },
  { id:"orange_miss2", color:"#FF6347", text:"Томатный", tone:"тёплый", style:"повседневный", season:"осень", colortype:"осень", textureHint:"Хлопок", makeupHint:"Румяна тёплые", makeupSet:{ lips:"Терракотовая", eyes:"Коричневые", blush:"Тёплые", eyeliner:"Коричневая", style:"Повседневный" }, hue: 58 },
  { id:"orange_miss3", color:"#FF4500", text:"Красно-оранжевый", tone:"тёплый", style:"энергичный", season:"осень", colortype:"осень", textureHint:"Хлопок", makeupHint:"Румяна оранжевые", makeupSet:{ lips:"Оранжевая", eyes:"Золотистые", blush:"Тёплые", eyeliner:"Коричневая", style:"Энергичный" }, hue: 62 }
);
...
colors.push(
  ...
  // ДОБАВЛЕННЫЕ ЖЕЛТО-ЗЕЛЕНЫЕ
  { id:"yellow_green_miss1", color:"#ADFF2F", text:"Зеленовато-желтый", tone:"тёплый", style:"свежий", season:"весна", colortype:"весна", textureHint:"Лён", makeupHint:"Тени салатовые", makeupSet:{ lips:"Нюдовая", eyes:"Салатовые", blush:"Светлые", eyeliner:"Коричневая", style:"Свежий" }, hue: 84 },
  { id:"yellow_green_miss2", color:"#9ACD32", text:"Желто-зеленый", tone:"тёплый", style:"повседневный", season:"весна", colortype:"весна", textureHint:"Хлопок", makeupHint:"Тени желто-зелёные", makeupSet:{ lips:"Нюдовая", eyes:"Жёлто-зелёные", blush:"Светлые", eyeliner:"Коричневая", style:"Повседневный" }, hue: 88 },
  { id:"yellow_green_miss3", color:"#7FFF00", text:"Яркий зелено-желтый", tone:"тёплый", style:"яркий", season:"весна", colortype:"весна", textureHint:"Лён", makeupHint:"Тени яркие", makeupSet:{ lips:"Нюдовая", eyes:"Ярко-зелёные", blush:"Светлые", eyeliner:"Коричневая", style:"Яркий" }, hue: 92 }
);

// СЕКТОР 120-180°: ЗЕЛЕНЫЕ
colors.push(
  { id:"bal9", color:"#7cfc00", text:"Зелёно-салатовый", tone:"тёплый", style:"свежий", season:"весна", colortype:"весна", textureHint:"Лён", makeupHint:"Тени салатовые", makeupSet:{ lips:"Нюдовая", eyes:"Салатовые", blush:"Светлые", eyeliner:"Коричневая", style:"Свежий" }, hue: 150 },
  { id:"green_add1", color:"#50ff50", text:"Ярко-салатовый", tone:"тёплый", style:"энергичный", season:"весна", colortype:"весна", textureHint:"Хлопок", makeupHint:"Тени яркие", makeupSet:{ lips:"Нюдовая", eyes:"Зелёные", blush:"Светлые", eyeliner:"Коричневая", style:"Энергичный" }, hue: 155 },
  { id:"br5", color:"#00ff00", text:"Ярко‑зелёный", tone:"свежий", style:"повседневный", season:"весна", colortype:"весна", textureHint:"Лён", makeupHint:"Тени зелёные", makeupSet:{ lips:"Нюдовая", eyes:"Зелёные", blush:"Светлые", eyeliner:"Коричневая", style:"Повседневный" }, hue: 160 },
  { id:"spb4", color:"#32cd32", text:"Ярко‑зелёный", tone:"свежий", style:"креативный", season:"весна", colortype:"весна", textureHint:"Лён", makeupHint:"Тени ярко‑зелёные", makeupSet:{ lips:"Нюдовая", eyes:"Ярко‑зелёные", blush:"Светлые", eyeliner:"Коричневая", style:"Креативный" }, hue: 165 },
  { id:"green_add2", color:"#00FF7F", text:"Весенний зелёный", tone:"тёплый", style:"свежий", season:"весна", colortype:"весна", textureHint:"Лён", makeupHint:"Тени зелёные", makeupSet:{ lips:"Нюдовая", eyes:"Зелёные", blush:"Светлые", eyeliner:"Коричневая", style:"Свежий" }, hue: 170 },
  { id:"sp5", color:"#98fb98", text:"Светло‑зелёный", tone:"тёплый", style:"повседневный", season:"весна", colortype:"весна", textureHint:"Лён", makeupHint:"Тени зелёные", makeupSet:{ lips:"Нюдовая", eyes:"Зелёные", blush:"Персиковые", eyeliner:"Коричневая", style:"Повседневный" }, hue: 175 },
  { id:"green_bl_add1", color:"#70e070", text:"Свежий зелёный", tone:"тёплый", style:"повседневный", season:"лето", colortype:"лето", textureHint:"Хлопок", makeupHint:"Тени зелёные", makeupSet:{ lips:"Нюдовая", eyes:"Зелёные", blush:"Светлые", eyeliner:"Серая", style:"Повседневный" }, hue: 178 }
);

// СЕКТОР 180-240°: СИНИЕ И ЗЕЛЕНО-СИНИЕ
colors.push(
  ...
  // ДОБАВЛЕННЫЕ СИНИЕ
  { id:"blue_miss1", color:"#1E90FF", text:"Ярко-голубой", tone:"холодный", style:"свежий", season:"зима", colortype:"зима", textureHint:"Атлас", makeupHint:"Тени ярко‑голубые", makeupSet:{ lips:"Нюдовая", eyes:"Ярко‑голубые", blush:"Светлые", eyeliner:"Серая", style:"Свежий" }, hue: 195 },
  { id:"blue_miss2", color:"#00BFFF", text:"Глубокий небесный", tone:"холодный", style:"повседневный", season:"лето", colortype:"лето", textureHint:"Хлопок", makeupHint:"Тени голубые", makeupSet:{ lips:"Нюдовая", eyes:"Голубые", blush:"Светлые", eyeliner:"Серая", style:"Повседневный" }, hue: 200 },
  { id:"blue_miss3", color:"#6495ED", text:"Нежно-голубой", tone:"холодный", style:"романтический", season:"лето", colortype:"лето", textureHint:"Шёлк", makeupHint:"Тени голубые", makeupSet:{ lips:"Нюдовая", eyes:"Голубые", blush:"Розовые", eyeliner:"Серая", style:"Романтический" }, hue: 205 },
  ...
  { id:"wib5", color:"#1e90ff", text:"Ярко‑голубой", tone:"холодный", style:"свежий", season:"зима", colortype:"зима", textureHint:"Атлас", makeupHint:"Тени ярко‑голубые", makeupSet:{ lips:"Нюдовая", eyes:"Ярко‑голубые", blush:"Светлые", eyeliner:"Серая", style:"Свечий" }, hue: 210 },
...
colors.push(
  ...
  // ДОБАВЛЕННЫЕ ФИОЛЕТОВЫЕ
  { id:"violet_miss1", color:"#8A2BE2", text:"Фиолетово-синий", tone:"холодный", style:"креативный", season:"зима", colortype:"зима", textureHint:"Атлас", makeupHint:"Тени фиолетовые", makeupSet:{ lips:"Фуксия", eyes:"Фиолетовые", blush:"Холодные", eyeliner:"Чёрная", style:"Креативный" }, hue: 234 },
  { id:"violet_miss2", color:"#9370DB", text:"Средне-фиолетовый", tone:"холодный", style:"романтический", season:"лето", colortype:"лето", textureHint:"Шёлк", makeupHint:"Тени фиолетовые", makeupSet:{ lips:"Розовая", eyes:"Фиолетовые", blush:"Холодные", eyeliner:"Серая", style:"Романтический" }, hue: 238 },
  { id:"violet_miss3", color:"#BA55D3", text:"Орхидея", tone:"холодный", style:"элегантный", season:"зима", colortype:"зима", textureHint:"Атлас", makeupHint:"Тени фиолетовые", makeupSet:{ lips:"Пурпурная", eyes:"Фиолетовые", blush:"Холодные", eyeliner:"Чёрная", style:"Элегантный" }, hue: 242 },
...
// СЕКТОР 300-330°: ФИОЛЕТОВО-РОЗОВЫЕ И РОЗОВЫЕ
colors.push(
...
const schemeGenerators = {
  ...
  complement: (i, colorsArr = colors) => {
        const mainColor = colorsArr[i];
        const targetHue = (mainColor.hue + 180) % 360;
...
neutral: (i, colorsArr = colors) => {
    ...
    const allNeutralColors = colorsArr.filter(color => {
        ...
        return (
            ...
            color.id === 'dk1' || 
            color.id === 'wib3' || 
            color.id.startsWith('neut') ||
            // Коричневые оттенки
            color.id.startsWith('brown') ||
            // Универсальные цвета
    ...
    const sortedNeutrals = allNeutralColors
        .map(color => {
            ...
            let priority = 1;
            if (color.id.startsWith('brown')) priority = 2; // Коричневые важнее
            if (color.colortype === 'универсальный') priority = 3; // Универсальные самые важные
        ...
        .sort((a, b) => {
            // Сначала по приоритету, потом по близости
  ...
  // ПЕНТАДА - 5 гармоничных цветов с дорам-эффектами
pentadic: (i, colorsArr = colors) => {
    ...
    const applyDramaEffect = (color, effectType) => {
        ...
        switch(effectType) {
            ...
            case "crystal_dream":
                ...
                b = Math.min(255, b + 15); // Холодный отлив
                break;

            case "forest_whisper":
                // Лесной шепот - зеленый отлив
            ...
            case "purple_mist":
                // Фиолетовая дымка - фиолетовый отлив
            ...
            case "vintage_gold":
                // Винтажное золото - теплый затемненный
    ...
    targetHues.forEach((targetHue, index) => {
        const effectTypes = [
            "forest_whisper",    // Зеленый отлив для 72°
            "sunset_drama",      // Теплое затемнение для 144°
            "purple_mist",       // Фиолетовый отлив для 216°  
            "vintage_gold"       // Винтажное затемнение для 288°
        ];
...
accentTriad: (i, colorsArr = colors) => {
    ...
    console.log(`   🎨 Основной: ${baseColor.text} (${baseColor.hue}°)`);
...
tintedComplement: (i, colorsArr = colors) => {
    ...
    if (complementaryColor) {
        colorsArr.forEach((color, index) => {
            ...
            let hueDiff = Math.abs(color.hue - complementaryColor.hue);
            hueDiff = Math.min(hueDiff, 360 - hueDiff);
...
alsoGood: (i, colorsArr = colors) => {
    ...
    selectedGoodColors.forEach((color, index) => {
        const hueDiff = Math.min(
            ...
            360 - Math.abs(color.hue - baseHue)
        );
        console.log(`   ${index + 1}️⃣ Хороший: ${color.text} (${color.hue}°, Δ${hueDiff}°)`);
    });
    
    return [baseColor, ...selectedGoodColors];
},

// НЕУДАЧНЫЕ СОЧЕТАНИЯ - конфликтующие цвета
notGood: (i, colorsArr = colors) => {
    const baseColor = colorsArr[i];
    const baseHue = baseColor.hue;
    
    // Конфликтующие диапазоны: 40-50° и 130-140° от базового
    const conflictingRanges = [
        { min: 40, max: 50 },    // Слишком близко для контраста, слишком далеко для гармонии
        { min: 130, max: 140 }   // Неудобный угол - ни гармония, ни контраст
    ];
    
    const conflictingColors = [];
    
    conflictingRanges.forEach(range => {
        const targetHue1 = (baseHue + range.min) % 360;
        const targetHue2 = (baseHue + range.max) % 360;
        
        // Ищем ближайшие цвета к конфликтующим позициям
        [targetHue1, targetHue2].forEach(targetHue => {
            let closestColor = null;
            let minDiff = 360;
            
            colorsArr.forEach((color, index) => {
                if (index === i || conflictingColors.includes(color)) return;
            ...
            if (closestColor && minDiff <= 20) {
                conflictingColors.push(closestColor);
            }
        });
    });
    ...
    conflictingColors.forEach((color, index) => {
        ...
        console.log(`   ${index + 1}️⃣ Конфликт: ${color.text} (${color.hue}°, Δ${hueDiff}°)`);
    });
    
    return [baseColor, ...conflictingColors.slice(0, 4)];
},
...
soft: (i, colorsArr = colors) => {
    ...
    // Нейтральный цвет (серый, бежевый, коричневый)
    ...
    if (neutralColor) {
        console.log(`   ⚪ Нейтральный: ${neutralColor.text} (${neutralColor.hue}°)`);
    }
...
splitTriad: (i, colorsArr = colors) => {
    ...
    triadColors.forEach((color, index) => {
        ...
        const actualDiff = Math.min(
            Math.abs(color.hue - targetPos),
            360 - Math.abs(color.hue - targetPos)
        );
        console.log(`   ${index === 0 ? '①' : '②'} Смещенный: ${color.text} (${color.hue}°, цель ${targetPos}°, Δ${actualDiff}°)`);
    });
